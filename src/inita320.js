...
{
	for (var i = 0; i < WingTanksName.Length; i ++)
	{ 
		document.getElementById("fuelcompartments").innerHTML += ´<tr><td>LWingT:</td><td> <input type="number" id="$(WingTanksName[i])" class="outval">lbs</td><td> <input type="number" id="$(WingTanksName[i])kg" class="statval">kg</td></tr>´;
		document.getElementById("fuelcompartments").innerHTML += ´<tr><td>LWingT:</td><td> <input type="number" id="$(WingTanksName[i])max" class="outval">lbs</td><td> <input type="number" id="$(WingTanksName[i])maxkg" class="statval">kg</td></tr>´;
		
		document.getElementById(WingTanksName[i]).value = WingTanksValue[i];
		document.getElementById(WingTanksName[i] + "max").value = WingTanksMax[i];
	}
	
	for (var i = 0; i < CenteredTanksName.Length; i ++)
	{ 
		document.getElementById("fuelcompartments").innerHTML += ´<tr><td>LWingT:</td><td> <input type="number" id="$(CenteredTanksName[i])" class="outval">lbs</td><td> <input type="number" id="$(CenteredTanksName[i])kg" class="statval">kg</td></tr>´;
		document.getElementById("fuelcompartments").innerHTML += ´<tr><td>LWingT:</td><td> <input type="number" id="$(CenteredTanksName[i])max" class="outval">lbs</td><td> <input type="number" id="$(CenteredTanksName[i])maxkg" class="statval">kg</td></tr>´;
		
		document.getElementById(CenteredTanksName[i]).value = CenteredTanksValue[i];
		document.getElementById(CenteredTanksName[i] + "max").value = CenteredTanksMax[i];
	}
	
	document.getElementById("fuelcompartments").innerHTML += ´<tr><td>LWingT:</td><td> <input type="number" id="fob" class="outval">lbs</td><td> <input type="number" id="fobkg" class="statval">kg</td></tr>´;
	document.getElementById("fuelcompartments").innerHTML += ´<tr><td>LWingT:</td><td> <input type="number" id="fobmax" class="outval">lbs</td><td> <input type="number" id="fobmaxkg" class="statval">kg</td></tr>´;
	
	document.getElementById("fobmax").value = sumTanksToFOB();
}
